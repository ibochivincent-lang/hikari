...
const appHtml = fs.readFileSync('frontend/public/app.html', 'utf8');
...
const checks = [
  ...
  { name: 'Simple mode button present in DApp (app.html)', pass: appHtml.includes('id="btnSimpleMode"') },
  { name: 'Pro mode button present in DApp (app.html)', pass: appHtml.includes('id="btnProMode"') },
